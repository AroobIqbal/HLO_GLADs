...
*!  Diana Goldemberg, EduAnalytics   version 1.1   7apr2020
*==============================================================================*
...
cap program drop glad_microdata_to_clo_edit
program  define  glad_microdata_to_clo_edit, rclass
  ...
  quietly {
    ...
    * numbers (score_*) and dummies (hpro_*). Generating a CLO with only the
    ...
    foreach  id_combo of local id_combos {
      ...
      * Preserve the prepared file again before keep the combo of this iteration
      preserve
        ...
        * Exception for PASEC 2014: replicate weights are grade-specific
            ...
            if `pv_aggregate' == 1 {
              ...
              * If pv successed, store the estimates over the placeholders
              ...
              if _rc == 0 {
                ...
                replace n_`indicator'_`subgroup'  = e(N)
				tab m_`indicator'_`subgroup'
				tab se_`indicator'_`subgroup'
				tab n_`indicator'_`subgroup'
              }
            * End pv case
            }
